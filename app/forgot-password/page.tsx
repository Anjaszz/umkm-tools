...
export default function ForgotPasswordPage() {
            ...
            <div className="min-h-screen bg-[#E8ECEF] flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
                <div className="sm:mx-auto sm:w-full sm:max-w-md animate-fade-in-up">
                    <div className="clay-card p-10 text-center border-2 border-[#2ECC71]/20">
                        ...
                        <h1 className="text-2xl font-black text-[#1a1f24] mb-4">Email Terkirim!</h1>
                        <p className="text-gray-500 font-medium mb-8 leading-relaxed">
                            Kami telah mengirimkan instruksi pemulihan kata sandi ke <span className="text-[#1a1f24] font-bold">{email}</span>.
    ...
    return (
        <div className="min-h-screen bg-[#E8ECEF] flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md animate-fade-in-up">
                <Link href="/login" className="inline-flex items-center gap-2 text-sm font-bold text-gray-500 hover:text-[#2ECC71] transition-colors mb-8 ml-1">
                ...
                <div className="clay-card p-8 sm:p-10 border-2 border-white/50">
                    <div className="mb-8 text-center">
                        <h1 className="text-2xl font-black text-[#1a1f24] mb-2">Lupa Kata Sandi?</h1>
                        <p className="text-gray-500 font-medium">Masukkan email Anda untuk menerima tautan pemulihan</p>
                    </div>
                    ...
                    <form onSubmit={handleReset} className="space-y-6">
                        <div>
                            <label className="block text-sm font-black text-[#1a1f24] mb-2 ml-1">Email Terdaftar</label>
