            ...
            <div className="min-h-screen bg-[#E8ECEF] flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
                <div className="sm:mx-auto sm:w-full sm:max-w-md animate-fade-in-up">
                    <div className="clay-card p-10 text-center border-2 border-[#2ECC71]/20">
                        ...
                        <h1 className="text-2xl font-black text-[#1a1f24] mb-4">Sandi Berhasil Diubah!</h1>
        ...
        <div className="min-h-screen bg-[#E8ECEF] flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md animate-fade-in-up">
                <div className="flex items-center justify-center gap-3 mb-8">
                    <div className="p-3 bg-white rounded-2xl shadow-sm border border-[#2ECC71]/20">
                ...
                <div className="clay-card p-8 sm:p-10 border-2 border-white/50">
                    <div className="mb-8 text-center">
                        <h1 className="text-2xl font-black text-[#1a1f24] mb-2">Atur Sandi Baru</h1>
                        <p className="text-gray-500 font-medium">Silakan masukkan kata sandi baru untuk akun Anda</p>
                    </div>
                    ...
                    <form onSubmit={handleUpdatePassword} className="space-y-6">
                        <div>
                            <label className="block text-sm font-black text-[#1a1f24] mb-2 ml-1">Kata Sandi Baru</label>
                        ...
                        <div>
                            <label className="block text-sm font-black text-[#1a1f24] mb-2 ml-1">Konfirmasi Sandi Baru</label>
                            <div className="relative group">
                                <LockClosedIcon className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 group-focus-within:text-[#2ECC71] transition-colors" />
                                <input
                                    type="password"
